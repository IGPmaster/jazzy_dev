<template>
  <div>
    <footer class="bg-jazzy-blue pt-2">
      <!-- <div class="row">
      ...
      <div class="row bg-jazzy-blue pb-10">
        <div class="container mx-auto footerContainer bg-white p-10 rounded-xl">
          ...
          <div class="flex items-center justify-center">
            <img src="/images/JazzySpins_logo_wh.svg" loading="lazy" alt="Jazzy Spins Casino footer Logo"
              class="footer_logo p-5 shadow-md rounded-lg bg-jazzy-blue" height="" width="" />
          </div>
        </div>
      </div>
