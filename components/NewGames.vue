        ...
        <div v-else>
            <div class="py-10 md:py-20 bg-secondary_bg">
                    ...
                    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="grid grid-cols-1 lg:grid-cols-8 lg:gap-8 items-center">
                            <div class="col-span-full lg:col-span-6">
                                <p
                                    class="gamesSectionHead text-secondary text-center lg:text-left p-4 text-3xl font-bold">
                        ...
                        <div v-for="game in newGames.slice(-16).reverse()" :key="game.id" :class="'item-' + game.id"
                            ...
                            <div class="show show-first relative">
                                <a :href="regLink" target="_blank">
                                    <img class="rounded-md w-full" :src="game.image"
                                        @error="game.image = 'newGameImg.jpg'" loading="lazy"
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-10">
                    <div
                        class="flex flex-col sm:flex-row items-center justify-between bg-jazzy-blue p-5 sm:p-10 rounded-sm">
