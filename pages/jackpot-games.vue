...
import { jackpotGames, msgTranslate, regLink, } from '~/composables/globalData';
...
const visibleGames = computed(() => {
	return jackpotGames.value.filter(game => !failedImages.value.has(game.id));
});
...
useHead({
	title: 'Jackpot Games - Jazzy Spins Online Casino',
	meta: [
		{ hid: 'description', name: 'description', content: 'Explore the best jackpot games available at Jazzy Spins!' },
		{ name: 'keywords', content: 'jackpot, games, casino, Jazzy Spins' }
	]
});
</script>
