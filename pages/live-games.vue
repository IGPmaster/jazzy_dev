...
import { fetchGames, liveGames, msgTranslate, regLink, loginLink } from '~/composables/globalData';
...
useHead({
	title: 'Live Games - Jazzy Spins Online Casino',
	meta: [
		{ hid: 'description', name: 'description', content: 'Explore the best live games available at Jazzy Spins!' },
		{ name: 'keywords', content: 'live, games, casino, Jazzy Spins' }
	]
});
</script>
